			...
			<section id="main" class="wrapper">
				<div class="container">
				  ...
				  <section> </section>
					...
					<!-- Form -->
						<section>
							<h3>Please select your university from the below dropdown menu:</h3>
							<form method="post" action="#">
								<div class="row uniform 50%">
									...
									<div class="12u$">
								      ...
								      <h4>Universilty not available? Click button below to proceed: </h4>
										  <li><input type="reset" value="Click to enter your University details" /></li>
									  </ul>
								  </div>
								</div>
							</form>
